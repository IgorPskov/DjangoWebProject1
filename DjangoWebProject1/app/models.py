...
class Comment(models.Model):
    ...
    date = models.DateTimeField(default = datetime.now(), db_index = True, verbose_name = "Статья комментария")
    ...
    # Метаданные - вложенный класс, который задает дополнительные параметры:
